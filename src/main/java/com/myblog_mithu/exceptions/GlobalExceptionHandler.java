...
import com.myblog_mithu.payload.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleResourceNotFoundException(ResourceNotFoundException resourceNotFoundException, WebRequest webRequest){
        ...
        ErrorDetails errorDetails = new ErrorDetails(resourceNotFoundException.getMessage(), new Date(), webRequest.getDescription(true));
